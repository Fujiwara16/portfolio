...
export const Content = () => {
    ...
    let[projects] = useState([{
      ...
      project:true,
      title: "Game Sensei",
      url: "https://github.com/K1RA-16/GameGenesis",
      body: "Provide UI for Searching games over a very large DB\nProvide latest popular games\nProvide a catalog of random games categorized by their genres\nA detailed game view screen which tells about the game such as its rating, publishers, description, platforms, stores, requirements and many more\nAll in all a perfect place to search games",
      techStack:"Xcode/Swift/SwiftUi/Cocoapods",
      role:"iOS Developer",
      ...
      url: "https://github.com/K1RA-16/Dayalbagh-Id-Card",
    ...
    },
    {
      ...
      project:true,
      title:"DB Gaushala",
      url: "https://github.com/K1RA-16/DB-gaushala-preview",
